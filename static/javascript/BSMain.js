function openNav1() {
  ...
  function testVariable() {
			...
			document.getElementById("showskill").src ="http://www.pdfdrive.com/"+ result +"-books.html";
        }
            ...
            if (listItems) {
                ...
                items.forEach(item => {
                    ...
                    itemElement.addEventListener('click', () => {
                      ...
                      document.getElementById('ifr').innerHTML = `<iframe class='iframer' src='http://www.youtube.com/embed/${item.id.videoId}'></iframe>`;
